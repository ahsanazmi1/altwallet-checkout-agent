...
class FeatureAttributions(BaseModel):
    ...
    cross_border_contribution: float = Field(0.0, description="Cross-border contribution")
    location_mismatch_contribution: float = Field(
        0.0, description="Location mismatch contribution"
    )
    velocity_24h_contribution: float = Field(0.0, description="24h velocity contribution")
    velocity_7d_contribution: float = Field(0.0, description="7d velocity contribution")
    chargeback_contribution: float = Field(0.0, description="Chargeback history contribution")
    merchant_risk_contribution: float = Field(0.0, description="Merchant risk contribution")
