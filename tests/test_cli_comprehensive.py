...
from altwallet_agent.cli import cli, score, simulate_decision, score_file, webhook_history
...
class TestScoreCommand:
    ...
    def test_score_with_input_file(self, mock_set_time, mock_set_trace, mock_score, runner, sample_context_file):
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_score_with_trace_id(self, mock_set_time, mock_set_trace, mock_score, runner, sample_context_file):
        """Test score command with custom trace ID."""
        mock_score.return_value = create_mock_score_result()
        
        result = runner.invoke(score, [
            '--input', str(sample_context_file),
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_score_pretty_output(self, mock_set_time, mock_set_trace, mock_score, runner, sample_context_file):
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_score_json_output(self, mock_set_time, mock_set_trace, mock_score, runner, sample_context_file):
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_score_verbose(self, mock_set_time, mock_set_trace, mock_score, runner, sample_context_file):
...
class TestSimulateDecisionCommand:
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_simulate_approve_decision(self, mock_set_time, mock_set_trace, mock_log, runner):
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_simulate_decline_decision(self, mock_set_time, mock_set_trace, mock_log, runner):
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_simulate_review_decision(self, mock_set_time, mock_set_trace, mock_log, runner):
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_simulate_with_discount_rule(self, mock_set_time, mock_set_trace, mock_log, runner):
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_simulate_with_kyc_rule(self, mock_set_time, mock_set_trace, mock_log, runner):
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_simulate_with_custom_parameters(self, mock_set_time, mock_set_trace, mock_log, runner):
        """Test simulating with custom parameters."""
        result = runner.invoke(simulate_decision, [
            '--approve',
            '--customer-id', 'custom_cust_456',
            '--merchant-id', 'custom_merch_789',
            '--amount', '250.50',
            '--mcc', '5812',
            '--region', 'CA'
        ])
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_simulate_no_decision_flag(self, mock_set_time, mock_set_trace, mock_log, runner):
        """Test simulating without any decision flag (should show error)."""
        result = runner.invoke(simulate_decision, [])
        assert result.exit_code == 0  # Click doesn't set exit code for errors in this case
...
class TestSimulateDecisionWithWebhooks:
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_simulate_with_webhook(self, mock_set_time, mock_set_trace, mock_log, mock_get_emitter, runner):
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_simulate_with_webhook_unavailable(self, mock_set_time, mock_set_trace, mock_log, runner):
...
class TestSimulateDecisionWithAnalytics:
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_simulate_with_analytics(self, mock_set_time, mock_set_trace, mock_log, runner):
...
class TestScoreFileCommand:
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_score_file_success(self, mock_set_time, mock_set_trace, mock_score, runner, sample_context_file):
...
class TestCLIErrorHandling:
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_score_processing_error(self, mock_set_time, mock_set_trace, mock_score, runner, sample_context_file):
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_simulate_decision_logging_error(self, mock_set_time, mock_set_trace, mock_log, runner):
...
class TestCLIIntegration:
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_full_score_workflow(self, mock_set_time, mock_set_trace, mock_score, runner, sample_context_file):
        """Test complete score workflow."""
        mock_score.return_value = create_mock_score_result()
        
        result = runner.invoke(score, [
            '--input', str(sample_context_file),
            '--trace-id', 'integration-test-123',
            '--pretty'
        ])
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_full_simulation_workflow(self, mock_set_time, mock_set_trace, mock_log, runner):
        """Test complete simulation workflow."""
        result = runner.invoke(simulate_decision, [
            '--approve',
            '--discount',
            '--kyc',
            '--customer-id', 'integration_cust_789',
            '--merchant-id', 'integration_merch_456',
            '--amount', '500.00',
            '--mcc', '5814',
            '--region', 'EU',
            '--analytics'
...
class TestCLIPerformance:
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_score_performance(self, mock_set_time, mock_set_trace, mock_score, runner, sample_context_file):
    ...
    @patch('altwallet_agent.cli.set_trace_id')
    @patch('altwallet_agent.cli.set_request_start_time')
    def test_simulation_performance(self, mock_set_time, mock_set_trace, mock_log, runner):
