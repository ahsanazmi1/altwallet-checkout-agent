...
class TestDeploymentManager:
    ...
    def test_deployment_manager_custom_config(self):
        ...
        config = DeploymentConfig(mode=DeploymentMode.INLINE, environment="production")
...
class TestInlineCheckoutClient:
    ...
    async def test_process_checkout_retry_logic(self, inline_client, mock_agent):
        ...
        mock_agent.process_checkout.side_effect = [
...
class TestSyncInlineCheckoutClient:
    ...
    def test_sync_client_initialize(self):
        ...
        with patch.object(
            client._client, "initialize", new_callable=AsyncMock
        ) as mock_init:
            client.initialize()
    ...
    def test_sync_client_process_checkout(self):
        ...
        with patch.object(
            client._client, "process_checkout", new_callable=AsyncMock
        ) as mock_process:
            mock_response = Mock()
    ...
    def test_sync_client_health_check(self):
        ...
        with patch.object(
            client._client, "health_check", new_callable=AsyncMock
        ) as mock_health:
    ...
    def test_sync_client_cleanup(self):
        ...
        with patch.object(
            client._client, "cleanup", new_callable=AsyncMock
        ) as mock_cleanup:
            client.cleanup()
...
class TestConvenienceFunctions:
    ...
    async def test_get_inline_client_singleton(self):
        ...
        with patch(
            "deployment.inline.embedded.InlineCheckoutClient"
