...
class TestAdditiveAttributions:
    ...
    def test_feature_contribution_values(self):
        ...
        valid_features = [
            "mcc", "amount", "issuer_family", "cross_border",
            "location_mismatch", "velocity_24h", "velocity_7d",
            "chargebacks_12m", "merchant_risk", "loyalty_tier"
        ]
    ...
    def test_top_drivers_extraction(self):
        ...
        # Extract top drivers
        top_drivers = self.scorer._extract_top_drivers(
            additive_attribs, top_k=3
        )
