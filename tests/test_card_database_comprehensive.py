...
class TestCardDatabaseInitialization:
    ...
    def test_cards_contain_expected_data(self):
        ...
        required_fields = [
            "name", "issuer", "annual_fee", "base_rewards_rate",
            "signup_bonus_points", "signup_bonus_value", "category_bonuses",
            "travel_benefits", "foreign_transaction_fee", "credit_score_required",
            "intro_apr", "intro_period_months"
        ]
    ...
    def test_specific_categories_exist(self):
        ...
        expected_categories = [
            "travel", "dining", "grocery_stores", "gas_stations",
            "online_shopping", "drugstores", "utilities"
        ]
...
class TestCardDatabaseRewardCalculation:
    ...
    def test_calculate_effective_reward_rate_nonexistent_category(self):
        ...
        rate = db.calculate_effective_reward_rate("chase_sapphire_preferred", "nonexistent_category")
...
class TestCardDatabaseEdgeCases:
    ...
    def test_category_data_types(self):
        ...
        for category_id, category_data in db.categories.items():
...
class TestCardDatabaseIntegration:
    ...
    def test_issuer_analysis(self):
        ...
        all_cards = db.get_all_cards()
        issuers = set(card_data["issuer"] for card_data in all_cards.values())
