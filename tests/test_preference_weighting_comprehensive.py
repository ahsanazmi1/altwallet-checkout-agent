...
"""
        ...
        with patch("builtins.open", mock_open(read_data=config_content)):
            with patch(
                ...
                assert (
                    weighting.config["user_preferences"]["cashback_vs_points_weight"]
                    == 0.7
                )
                assert (
                    weighting.config["user_preferences"]["issuer_affinity"]["chase"]
                    == 0.1
                )
...
class TestPreferenceWeightingCalculation:
    ...
    def test_calculate_user_preference_weight_cashback_preference(self, sample_context):
        ...
        weighting = PreferenceWeighting()
        weighting.config["user_preferences"][
        ...
        weight = weighting._calculate_user_preference_weight(
            cashback_card, sample_context
        )
    ...
    def test_calculate_user_preference_weight_foreign_fee_sensitive(
        self, sample_context
    ):
        """Test user preference weight with foreign fee sensitivity."""
        weighting = PreferenceWeighting()
        weighting.config["user_preferences"][
            "foreign_fee_sensitivity"
        ] = 0.3  # Fee-sensitive
        ...
        weight = weighting._calculate_user_preference_weight(
            foreign_fee_card, sample_context
        )
        assert weight < 1.0  # Should get penalty for foreign fee

    def test_calculate_user_preference_weight_invalid_config_values(
        self, sample_context
    ):
    ...
    def test_calculate_loyalty_weight_different_tiers(self, sample_context):
        ...
        for tier, expected_weight in zip(tiers, expected_weights, strict=False):
    ...
    def test_calculate_category_weight_with_mcc_match(
        self, sample_card, sample_context
    ):
    ...
    def test_calculate_category_weight_without_mcc_match(self, sample_context):
        ...
        card = {"name": "No Bonus Card", "category_bonuses": {}}
    ...
    def test_calculate_category_weight_invalid_config(
        self, sample_card, sample_context
    ):
    ...
    def test_calculate_promotion_weight_with_signup_bonus(self, sample_context):
        ...
        card = {"name": "Bonus Card", "signup_bonus_points": 100000}
    ...
    def test_calculate_promotion_weight_inactive_seasonal_promotion(
        self, sample_context
    ):
...
class TestPreferenceWeightingPromotionHelpers:
    ...
    def test_is_promotion_active_within_year(self):
        ...
        promotion_data = {"start_date": "06-01", "end_date": "08-31"}
    ...
    def test_is_promotion_active_cross_year(self):
        ...
        promotion_data = {"start_date": "12-01", "end_date": "02-28"}
    ...
    def test_is_promotion_active_invalid_dates(self):
        ...
        promotion_data = {"start_date": "invalid", "end_date": "08-31"}
        assert weighting._is_promotion_active(promotion_data, current_date) is False
