...
class OrcaCheckoutUser(HttpUser):
    ...
    def _generate_transaction_data(self):
        ...
        # Sample cities
        cities = [
            {"city": "San Francisco", "region": "CA", "country": "US", "lat": 37.7749, "lon": -122.4194},
            {"city": "New York", "region": "NY", "country": "US", "lat": 40.7128, "lon": -74.0060},
            {"city": "Los Angeles", "region": "CA", "country": "US", "lat": 34.0522, "lon": -118.2437},
            {"city": "Chicago", "region": "IL", "country": "US", "lat": 41.8781, "lon": -87.6298},
        ...
        return {
            ...
            "merchant": {
                "name": merchant["name"],
                "mcc": merchant["mcc"],
                "network_preferences": random.choice([["visa", "mc"], ["visa"], ["mc"], ["amex"]]),
                "location": {
                    "city": city["city"],
