...
class TestDemoCommand:
    ...
    def test_demo_context_creation(self):
        ...
        with patch('altwallet_merchant_agent.cli.console.print') as mock_print:
            ...
            demo(merchant="Whole Foods", amount=180.0, location="New York", 
                 json_output=True, verbose=False, p_approval=0.95, geo_promo=False)
    ...
    def test_different_inputs_produce_different_scores(self):
        ...
        with patch('altwallet_merchant_agent.cli.console.print') as mock_print:
            ...
            demo(merchant="Whole Foods", amount=200.0, location="New York", 
                 json_output=True, verbose=False, p_approval=0.95, geo_promo=False)
            second_call = mock_print.call_args[0][0]
            ...
            assert first_result["score"] != second_result["score"]
            assert first_result["score"] == 5.13  # 180 * 0.03 * 0.95
            assert second_result["score"] == 5.7   # 200 * 0.03 * 0.95
    ...
    def test_demo_calculation_logic(self):
        ...
        for amount, expected_score in test_cases:
            with patch('altwallet_merchant_agent.cli.console.print') as mock_print:
                demo(merchant="Test Merchant", amount=amount, location="Test Location", 
                     json_output=True, verbose=False, p_approval=0.95, geo_promo=False)
    ...
    def test_p_approval_enhancement(self):
        ...
        with patch('altwallet_merchant_agent.cli.console.print') as mock_print:
            ...
            demo(merchant="Test Merchant", amount=100.0, location="Test Location", 
                 json_output=True, verbose=False, p_approval=0.8)
    ...
    def test_geo_promo_enhancement(self):
        ...
        with patch('altwallet_merchant_agent.cli.console.print') as mock_print:
            ...
            demo(merchant="Test Merchant", amount=100.0, location="Test Location", 
                 json_output=True, verbose=False, geo_promo=True)
    ...
    def test_p_approval_validation(self):
        ...
        with patch('altwallet_merchant_agent.cli.console.print') as mock_print:
            ...
            with pytest.raises(SystemExit):  # typer.Exit raises SystemExit
                demo(merchant="Test Merchant", amount=100.0, location="Test Location", 
                     json_output=True, verbose=False, p_approval=1.5)  # Invalid: > 1
