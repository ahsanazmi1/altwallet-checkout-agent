...
def sample_merchant_penalty_config():
    ...
    return {
        "merchants": {
            "amazon": {"5411": 0.9, "5942": 0.85, "default": 0.8},
            "starbucks": {"5814": 0.95, "default": 0.9},
        },
        "mcc_families": {
...
def sample_context():
    ...
    return Context(
        cart=Cart(
            items=[CartItem(item="Test Item", unit_price=150.00, qty=1, mcc="5411")],
            currency="USD",
        ),
...
class TestMerchantPenaltyCalculation:
    ...
    def test_merchant_penalty_amazon_visa(
        self, merchant_penalty_with_config, sample_context
    ):
    ...
    def test_merchant_penalty_amazon_amex(
        self, merchant_penalty_with_config, sample_context
    ):
    ...
    def test_merchant_penalty_starbucks_amex(
        self, merchant_penalty_with_config, sample_context
    ):
    ...
    def test_merchant_penalty_unknown_merchant(
        self, merchant_penalty_with_config, sample_context
    ):
    ...
    def test_merchant_penalty_unknown_mcc(
        self, merchant_penalty_with_config, sample_context
    ):
    ...
    def test_merchant_penalty_unknown_network(
        self, merchant_penalty_with_config, sample_context
    ):
...
class TestMerchantPenaltyFuzzyMatching:
    ...
    def test_fuzzy_match_amazon_variations(
        self, merchant_penalty_with_config, sample_context
    ):
    ...
    def test_fuzzy_match_starbucks_variations(
        self, merchant_penalty_with_config, sample_context
    ):
...
class TestMerchantPenaltyEdgeCases:
    ...
    def test_merchant_penalty_empty_merchant_id(
        self, merchant_penalty_with_config, sample_context
    ):
    ...
    def test_merchant_penalty_none_merchant_id(
        self, merchant_penalty_with_config, sample_context
    ):
    ...
    def test_merchant_penalty_empty_network(
        self, merchant_penalty_with_config, sample_context
    ):
    ...
    def test_merchant_penalty_empty_mcc(
        self, merchant_penalty_with_config, sample_context
    ):
    ...
    def test_merchant_penalty_invalid_mcc(
        self, merchant_penalty_with_config, sample_context
    ):
...
class TestMerchantPenaltyIntegration:
    ...
    def test_penalty_calculation_workflow(
        self, merchant_penalty_with_config, sample_context
    ):
        ...
        penalties = []
        for _merchant_id, _network, _mcc in test_cases:
            penalty = merchant_penalty_with_config.merchant_penalty(sample_context)
    ...
    def test_penalty_range_validation(
        self, merchant_penalty_with_config, sample_context
    ):
        ...
        for merchant in merchants:
            for network in networks:
                for mcc in mccs:
                    penalty = merchant_penalty_with_config.merchant_penalty(
                        sample_context
                    )
                    assert (
                        0.0 <= penalty <= 1.0
                    ), f"Penalty {penalty} out of range for {merchant}/{network}/{mcc}"


class TestMerchantPenaltyPerformance:
    """Test merchant penalty performance characteristics."""

    def test_penalty_calculation_performance(
        self, merchant_penalty_with_config, sample_context
    ):
