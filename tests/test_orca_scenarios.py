...
class TestOrcaScenarios:
    ...
    def test_orca_online_grocery_scenario(
        self, agent, orca_fixtures_dir, orca_snapshots_dir
    ):
        ...
        assert response.routing_hints.preferred_network in [
            "visa",
            "mc",
            "amex",
        ]
    ...
    def test_orca_in_person_retail_scenario(
        self, agent, orca_fixtures_dir, orca_snapshots_dir
    ):
    ...
    def test_orca_high_risk_cross_border_scenario(
        self, agent, orca_fixtures_dir, orca_snapshots_dir
    ):
    ...
    def test_orca_surcharge_suppression_scenario(
        self, agent, orca_fixtures_dir, orca_snapshots_dir
    ):
    ...
    def test_orca_loyalty_boost_scenario(
        self, agent, orca_fixtures_dir, orca_snapshots_dir
    ):
            ...
            },
            {
                ...
                "data": {
                    ...
                    "merchant": {
                        ...
                        "mcc": "5094",
                        "network_preferences": ["visa"],
                        "location": {"city": "Test", "country": "CA"},
                    },
                    "customer": {
                        "id": "test",
                        "loyalty_tier": "NONE",
                        "historical_velocity_24h": 20,
                        "chargebacks_12m": 2,
                    },
                    "device": {
                        "ip": "203.0.113.1",
                        "device_id": "test",
                        "ip_distance_km": 1000.0,
                        "location": {"city": "Test", "country": "US"},
                    },
                    "geo": {
                        "city": "Test",
