...
class TestCheckoutAgentDependencies:
    ...
    def test_get_card_database(self, checkout_agent):
        ...
        with patch('altwallet_agent.data.card_database.get_card_database') as mock_get_db:
...
class TestCheckoutAgentProcessing:
    ...
    def test_process_checkout_with_intelligence_engine(self, checkout_agent, sample_checkout_request):
    ...
    def test_process_checkout_intelligence_import_error(self, checkout_agent, sample_checkout_request):
    ...
    def test_process_checkout_intelligence_exception(self, checkout_agent, sample_checkout_request):
    ...
    def test_process_checkout_enhanced_success(self, checkout_agent, sample_checkout_request):
    ...
    def test_process_checkout_enhanced_exception(self, checkout_agent, sample_checkout_request):
        """Test enhanced checkout processing with exception."""
        with patch.object(checkout_agent, '_get_approval_scorer', side_effect=Exception("Test error")):
            response = checkout_agent.process_checkout_enhanced(sample_checkout_request)
...
class TestCheckoutAgentContextVariables:
    ...
    def test_context_variables_set_during_processing(self, checkout_agent, sample_checkout_request):
    ...
    def test_context_variables_unique_per_request(self, checkout_agent, sample_checkout_request):
...
class TestCheckoutAgentPerformance:
    ...
    def test_enhanced_processing_time_tracking(self, checkout_agent, sample_checkout_request):
...
class TestCheckoutAgentIntegration:
    ...
    def test_full_checkout_workflow(self, checkout_agent, sample_checkout_request):
        ...
        with patch.object(checkout_agent, '_process_checkout_basic') as mock_basic:
            ...
            assert response.status == "completed"
            assert response.score > 0.4  # Score should be reasonable
            assert len(response.recommendations) >= 1  # Should have at least one recommendation
