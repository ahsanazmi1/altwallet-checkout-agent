...
def main():
    ...
    total = (
        attributions.mcc_contribution
        + attributions.amount_contribution
        + attributions.issuer_contribution
        + attributions.cross_border_contribution
        + attributions.location_mismatch_contribution
        + attributions.velocity_24h_contribution
        + attributions.velocity_7d_contribution
        + attributions.chargeback_contribution
        + attributions.merchant_risk_contribution
        + attributions.loyalty_contribution
